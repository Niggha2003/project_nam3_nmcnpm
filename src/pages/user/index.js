                    ...
                    <div class="user_modify">
                        ...
                        <div class="user_modify_frame">
                                <div class="user_input_address">
                                    ...
                                    <input type="text" class="user_dcnguoidung" placeholder="Nhập địa chỉ người dùng"></input>
                                </div>
            
                                <div class="user_input_birthday">
                                    <p class="user_ngaysinh">Ngày sinh:</p>
                                    <input type="text" class="user_dob" placeholder="Nhập ngày sinh"></input>
                                </div>
            
                                <div class="user_input_phone">
                                    <p class="user_sdt">SĐT:</p>
                                    <input type="text" class="user_phonenumber" placeholder="Nhập số điện thoại"></input>
                                </div>
            
                                <div class="user_input_name">
                                    <p class="user_hoten">Họ tên:</p>
                                    <input type="text" class="user_fullname" placeholder="Nhập họ và tên"></input>
                                </div>
                        </div>
...
document.body.appendChild(HeaderFooter(User));